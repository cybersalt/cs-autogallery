...
### 🚀 New Features
- **Image Border Radius**: New setting to control the corner rounding on gallery thumbnails (e.g., `0.5rem`, `8px`, `50%`, `0`). Defaults to `0.5rem`. Can also be set per-shortcode with `border_radius="10px"`.

## [1.7.0] - 2026-01-03

### 🔧 Improvements
- **Case-Insensitive Folder Matching**: The plugin now finds image folders regardless of letter casing. If `10-Ft-Ganja-Plant` doesn't exist but `10-ft-Ganja-Plant` does, it will use the actual folder on disk.
